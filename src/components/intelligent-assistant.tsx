...
import { intelligentAssistant } from '@/ai/flows/intelligent-assistant';
...
export default function IntelligentAssistant() {
  const [messages, setMessages] = useState<Message[]>([
    { sender: 'bot', text: 'Hello! How can I help you with AgriConnect today?' },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      const result = await intelligentAssistant({ query: input });
